...
const file_proto_basic_user_group_proto_rawDesc = "" +
	"\n" +
	"\x1cproto/basic/user_group.proto\x1a\x16proto/basic/user.proto\"\x9c\x01\n" +
	"\tUserGroup\x12\x1a\n" +
	"\bgroup_id\x18\x01 \x01(\rR\bgroup_id\x12\x1e\n" +
	"\n" +
	"group_name\x18\x02 \x01(\tR\n" +
	"group_name\x12\x14\n" +
	"\x05roles\x18\x03 \x03(\tR\x05roles\x12\x1b\n" +
	"\x05users\x18\x04 \x03(\v2\x05.UserR\x05users\x12 \n" +
	"\vdescription\x18\x10 \x01(\tR\vdescriptionB'Z%microservice_with_grpc/protogen/basicb\x06proto3"

var (
	file_proto_basic_user_group_proto_rawDescOnce sync.Once
	file_proto_basic_user_group_proto_rawDescData []byte
)

func file_proto_basic_user_group_proto_rawDescGZIP() []byte {
	file_proto_basic_user_group_proto_rawDescOnce.Do(func() {
		file_proto_basic_user_group_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_basic_user_group_proto_rawDesc), len(file_proto_basic_user_group_proto_rawDesc)))
	})
...
func file_proto_basic_user_group_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_basic_user_group_proto_rawDesc), len(file_proto_basic_user_group_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
